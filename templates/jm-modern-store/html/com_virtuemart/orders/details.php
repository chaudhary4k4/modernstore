...
if($this->print){
	?>
		<div class="vm-orderdetails-view">
	...
	?>
<div class="vm-wrap">	
	<div class="vm-orderdetails-view vm-orders-information">
...
<?php if($this->order_list_link){ ?>
	<div class='spaceStyle'>
		...
		<a class="link-listorders" href="<?php echo $this->order_list_link ?>" rel="nofollow"><?php echo vmText::_('COM_VIRTUEMART_ORDERS_VIEW_DEFAULT_TITLE'); ?></a>
	    </div>
	    <div class="clear"></div>
	</div>
<?php }?>
